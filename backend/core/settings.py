...
SECRET_KEY = 'django-insecure-t+t0q&b*ob=5cr7!eef6rye4bp5@75$rv=3&*slk)!xwrnb6is'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=120),   # duración del access token
    ...
    'BLACKLIST_AFTER_ROTATION': True,                # invalida el refresh antiguo
}